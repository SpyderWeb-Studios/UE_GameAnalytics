...
#include "UE_GameAnalyticsEditorMode.generated.h"
 ...
 */
UCLASS()
class UUE_GameAnalyticsEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_UE_GameAnalyticsEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UUE_GameAnalyticsEditorMode();
	virtual ~UUE_GameAnalyticsEditorMode();

...
#include "UE_GameAnalyticsInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UUE_GameAnalyticsInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UUE_GameAnalyticsInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UUE_GameAnalyticsInteractiveTool* NewTool = NewObject<UUE_GameAnalyticsInteractiveTool>(SceneState.ToolManager);
...
void UUE_GameAnalyticsInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UUE_GameAnalyticsInteractiveTool::Setup()
{
	...
	Properties = NewObject<UUE_GameAnalyticsInteractiveToolProperties>(this, "Measurement");
...
void UUE_GameAnalyticsInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UUE_GameAnalyticsInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UUE_GameAnalyticsInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UUE_GameAnalyticsInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UUE_GameAnalyticsInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UUE_GameAnalyticsInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UUE_GameAnalyticsInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UUE_GameAnalyticsInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UUE_GameAnalyticsInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

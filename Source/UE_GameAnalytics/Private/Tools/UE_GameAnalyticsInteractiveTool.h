...
#include "UE_GameAnalyticsInteractiveTool.generated.h"
 ...
 */
UCLASS()
class UE_GAMEANALYTICS_API UUE_GameAnalyticsInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class UE_GAMEANALYTICS_API UUE_GameAnalyticsInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UUE_GameAnalyticsInteractiveToolProperties();
 ...
 */
UCLASS()
class UE_GAMEANALYTICS_API UUE_GameAnalyticsInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UUE_GameAnalyticsInteractiveToolProperties> Properties;
